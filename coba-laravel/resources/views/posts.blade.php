...
<div class="card mb-3">
  ...
  <div class="card-body text-center">
    <h3 class="card-title"><a href="/posts"></a> <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none text-dark">{{ $posts[0]->title }}</a></h3>
    <p>
    ...
    <a href="/posts"></a> <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn-primary">Read more</a>
